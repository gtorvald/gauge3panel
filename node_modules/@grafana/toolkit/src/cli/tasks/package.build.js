...
var moveStaticFiles = function (pkg) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var staticFiles_1;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!pkg.name.endsWith('/ui')) return [3 /*break*/, 2];
                return [4 /*yield*/, globby_1.default('src/**/*.{png,svg,gif,jpg}')];
            case 1:
                            ...
                            switch (_a.label) {
                                case 0:
                                    promises = staticFiles_1.map(function (file) {
                                        return new Promise(function (resolve, reject) {
                                            fs.copyFile(file, file.replace(/^src/, 'compiled'), function (err) {
                                                if (err) {
                                                    reject(err);
                                                    return;
                                                }
                        ...
                        return function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        _a.sent();
                                        return [4 /*yield*/, moveStaticFiles(pkg)];
                                    case 3:
                                        _a.sent();
