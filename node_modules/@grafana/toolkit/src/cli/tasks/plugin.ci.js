...
var packagePluginRunner = function (_a) {
    var signingAdmin = _a.signingAdmin;
    return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var start, ciDir, packagesDir, distDir, docsDir, jobsDir, grafanaEnvDir, distContentDir, d, dirs, dirs_1, dirs_1_1, j, contents, er_1, e_2_1, pluginJsonFile, pluginInfo, _b, grabplCommandFlags, err_1, zipName, zipFile, zipStats, info, _c, p, _d, customIniBody;
        var e_2, _e;
        return tslib_1.__generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 12:
                    try {
                        if (dirs_1_1 && !dirs_1_1.done && (_e = dirs_1.return)) _e.call(dirs_1);
                    }
                ...
                case 15:
                    ...
                    grabplCommandFlags = signingAdmin ? ['build-plugin-manifest', '--signing-admin'] : ['build-plugin-manifest'];
                    return [4 /*yield*/, execa('grabpl', tslib_1.__spread(grabplCommandFlags, [distContentDir]))];
                case 16:
                    _f.sent();
                    return [3 /*break*/, 18];
                case 17:
